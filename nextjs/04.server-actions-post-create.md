...
![POST 创建用户全流程](../image/nextjs-04-server-actions/04-02-post-create-flow.png)
...
![Client POST vs Server Actions](../image/nextjs-04-server-actions/04-01-client-vs-server-action.png)
...
![提交三态与 redirect / revalidatePath](../image/nextjs-04-server-actions/04-03-form-states-redirect.png)
