...
![RAG 全链路 · 用户眼里发生什么](assets/06-01-rag-pipeline.png)
...
![四个页面 · 路由与交付物](assets/06-02-four-pages-routes.png)
...
![RAG 功能 · Server 还是 Client](assets/06-03-rag-server-client.png)
