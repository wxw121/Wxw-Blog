...
![正文与出处 · 别混在一个字段](../image/nextjs-09-citation-ui/09-02-content-vs-citations.png)
...
![SSE 双事件 · token 与 citations 分两路](../image/nextjs-09-citation-ui/09-01-sse-dual-events.png)
...
![聊天 + 侧栏 · 数据流与布局](../image/nextjs-09-citation-ui/09-03-chat-sidebar-flow.png)
